...
| Key                                   | Action                      |
| ------------------------------------- | --------------------------- |
| `/` or `Ctrl+Shift+F` (`Cmd+Shift+F`) | Full-text slide search      |
| `Ctrl+K` (`Cmd+K`)                    | Command palette             |
| `Ctrl+F` (`Cmd+F`)                    | Search within current slide |
| `Ctrl+G` (`Cmd+G`)                    | Jump to next search result  |
...
| `Alt+T` | Toggle current slide's theme (`theme:` directive) |
...
- There are two distinct theme toggles: `T` toggles the global **app theme** (UI chrome), while `Alt+T` toggles the current **slide's theme** (`theme:` directive).
