...
**Part 2: Second 50-Minute Session (~15-18 slides)** 6. Part 2 Opening (header + main) - recap Part 1, preview Part 2 7. Advanced Content with Integrated Activities (same variety as Part 1) 8. Common Mistakes & Debugging (header + two columns - errors left, fixes right) 9. Submission Instructions (single centered with colored background) - screenshots, hand-in template 10. Further Reading/References (two equal columns) 11. Summary & Q&A (single centered or centered title)
...
5. Include **4-6 short activities** spread throughout (every 4-5 slides), not grouped together
