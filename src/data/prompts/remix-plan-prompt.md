...
- Prefer `merge` when adjacent slides are thin, overlapping, or redundant. Also merge when combining slides tightens the narrative or removes repetition. Avoid merging slides with clearly distinct topics or strong standalone value.
