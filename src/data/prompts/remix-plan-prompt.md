...
- Use `merge` when adjacent slides are thin, overlapping, or redundant, and combining them clearly improves the deck. Do not merge slides with distinct topics, key takeaways, or strong standalone value.
