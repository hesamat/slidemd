...
- Use `keep` only for slides that are already clear, well-structured, in the right place, and at a good density. When in doubt, `rewrite` — a slide that looks fine in outline may still benefit from tightening.
