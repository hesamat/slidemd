...
Do not preserve the original color theme, colored text, backgrounds, or visual language. The source deck's `theme:`, `background:`, `color:`, `backgroundColor:`, and `area-bg-*:` directives have already been stripped. The execution AI is free to choose a new professional color scheme, `theme:`, `background:`, and colored text as appropriate for the remixed content. It may vary backgrounds across the deck.
