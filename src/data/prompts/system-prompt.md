...
- Use `::: text-block { ... }` for styled or multi-column text. Never use raw `<div style="...">`. Attributes MUST be inside `{ }` braces. Example: `::: text-block { backgroundColor="#1e293b" markdown=true }\n### Heading\n- item\n:::`. Blank lines inside the directive are optional.
