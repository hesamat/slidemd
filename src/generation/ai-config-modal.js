...
export class AIConfigModal {
    ...
    static async show() {
        return new Promise((resolve) => {
            ...
            if (defaultProvider) {
                const selectedCard = backdrop.querySelector(`[data-provider="${defaultProvider.providerId}"]`);
                if (selectedCard) {
            ...
            function selectProvider(card) {
                ...
                // Update test button
                testBtn.classList.remove('ai-config-modal__test-btn--success', 'ai-config-modal__test-btn--error');
            ...
            apiKeyToggle.onclick = () => {
                ...
                apiKeyToggle.innerHTML = type === 'password'
            ...
            testBtn.onclick = async () => {
                const providerId = backdrop.querySelector('.ai-config-modal__provider-card.selected')?.dataset.provider;
                if (!providerId) {
