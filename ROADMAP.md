...
| [x] Redesign image properties Style tab (#126)            | Replace shadow preset buttons with explicit offset/blur/color controls using a compact control-row pattern. Add image filters (brightness, contrast, saturation) and horizontal/vertical flip. Fix arrow key conflict with number inputs. Remove border and layer-order controls.                                                                                                                                                                                                                                                                                                                                    |
