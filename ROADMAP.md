...
| [x] Flow-aware plan guidance   | Inject per-flow restructuring priorities (instructional/story/technical/persuasive) into the remix plan prompt so keep/rewrite/merge/reorder decisions follow the chosen flow. |
