...
| [x] Preserve text as fallback      | Shapes with text should keep the text content in the slide markdown alongside the rendered image, so it remains searchable and editable.                                                                                                                                                                                                                                                                                                       |
